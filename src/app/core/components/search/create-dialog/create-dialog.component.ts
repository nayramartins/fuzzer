...
export class CreateDialogComponent implements OnInit {
  ...
  close(): void {
    this.spotifyService.createMagicPlaylist(
      this.user.id,
      this.playlist.name,
      `${this.playlist.description} - generated by fuzzer.rocks 🤘`,
      this.playlist.public
    ).subscribe(playlist => {
      this.spotifyService.playlistLink.next(playlist);
      this.getSongsURI()
